class App extends React.Component {
  state = {
    ingredients: ["Pork Belly", "Ramen Noodles", "Seasoned Egg", "Bean Sprouts", "Fresh Scallions", "Bok Choy Leaves", "Maitake Mushrooms", "Kanabo Spice"],
    ramenBowls: [],
    ingredient1: "",
    ingredient2: "",
    ingredient3: "",
          ...
          <div className="options-left">
            <h2>Available Ingredients</h2>
            {
              this.state.ingredients.map((ingredient) => {
                return <h3 onClick={this.addIngredient} className="toppings" id={ingredient}>{ingredient}</h3>
              })
            }
          </div>
          <div className="options-right">
            <h2>Your Ramen Bowl</h2>
            {this.state.ingredient1 ? <h3 className="toppings">{this.state.ingredient1}</h3> : ""}
            {this.state.ingredient2 ? <h3 className="toppings">{this.state.ingredient2}</h3> : ""}
            {this.state.ingredient3 ? <h3 className="toppings">{this.state.ingredient3}</h3> : ""}
            {this.state.ingredient4 ? <h3 className="toppings">{this.state.ingredient4}</h3> : ""}
            {this.state.ingredient5 ? <h3 className="toppings">{this.state.ingredient5}</h3> : ""}
            {this.state.ingredient6 ? <h3 className="toppings">{this.state.ingredient6}</h3> : ""}
          </div>
        </div>
      </div>
    );
